...
namespace Ura.Data
{
    ...
    public class PersistentGenericSet<T> : AbstractPersistentCollection, ISet<T>
    {
        ...
        protected sealed class ClearDelayedOperation : IDelayedOperation
        {
            ...
            #endregion IDelayedOperation Members
        }

        #endregion Nested type: ClearDelayedOperation
        ...
        #endregion Nested type: SimpleAddDelayedOperation
        ...
        #endregion Nested type: SimpleRemoveDelayedOperation

        #endregion DelayedOperations
        ...
        #endregion Nested type: ISetSnapshot
        ...
        private class SetSnapShot<T> : ISetSnapshot<T>
        {
            ...
            #endregion ISetSnapshot<T> Members
        }

        #endregion Nested type: SetSnapShot
    }
}